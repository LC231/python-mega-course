...
with col1:
    st.image("Second_Project/images/photo.png")
...
content2 = """
Below you cna find some of the apps I have built in Python. Feel free to contact me
"""
st.write(content2)

col3, col4 = st.columns(2)

df = pandas.read_csv("Second_project/data.csv",sep=";")
